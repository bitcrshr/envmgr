...
import (
	...
	"github.com/bitcrshr/envmgr/api/ent/migrate"
...
// QueryVars queries the vars edge of a Environment.
func (c *EnvironmentClient) QueryVars(e *Environment) *VariableQuery {
...
type (
	hooks struct {
		Environment, Project, User, Variable []ent.Hook
	}
	inters struct {
		Environment, Project, User, Variable []ent.Interceptor
	}
)
