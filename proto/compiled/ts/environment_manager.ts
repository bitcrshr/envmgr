...
export enum Environment_Kind {
    ...
    UNSPECIFIED = 0,
    /**
     * @generated from protobuf enum value: KIND_DEVELOPMENT = 1;
     */
    DEVELOPMENT = 1,
    /**
     * @generated from protobuf enum value: KIND_STAGING = 2;
     */
    STAGING = 2,
    /**
     * @generated from protobuf enum value: KIND_PRODUCTION = 3;
     */
    PRODUCTION = 3
}
/**
...
class Project$Type extends MessageType<Project> {
    ...
    create(value?: PartialMessage<Project>): Project {
        const message = { id: "", displayName: "", ownerId: "" };
...
class Environment$Type extends MessageType<Environment> {
    constructor() {
        super("environment_manager.Environment", [
            ...
            { no: 3, name: "kind", kind: "enum", T: () => ["environment_manager.Environment.Kind", Environment_Kind, "KIND_"] }
        ]);
    }
...
class QueryVariablesRequest$Type extends MessageType<QueryVariablesRequest> {
    constructor() {
        super("environment_manager.QueryVariablesRequest", [
            { no: 1, name: "project_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "environment_kind", kind: "enum", T: () => ["environment_manager.Environment.Kind", Environment_Kind, "KIND_"] }
        ]);
    }
    create(value?: PartialMessage<QueryVariablesRequest>): QueryVariablesRequest {
        const message = { projectId: "", environmentKind: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* environment_manager.Environment.Kind environment_kind */ 2:
                    message.environmentKind = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: QueryVariablesRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.environmentKind !== 0)
            writer.tag(2, WireType.Varint).int32(message.environmentKind);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
